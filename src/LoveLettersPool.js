...
export function generateLoveLetter() {
    ...
    const salutationPool1 = [
      ...
      const adjectivesPool = [
        ...
        "CURIOUS", "EAGER", "LOVEABLE", "LOVESICK", "LOVING",
        "PASSIONATE", "PRECIOUS", "SEDUCTIVE", "SWEET", "SYMPATHETIC", "WINNING"
      ];
      
      const nounsPool = [
        "ADORATION", "AFFECTION", "AMBITION", "APPETITE", "BEING", "BURNING",
        "CHARM", "CRAVING", "DESIRE", "DEVOTION", "EAGERNESS", "ENTHUSIASM",
        "FANCY", "HEART", "HUNGER", "LITTLE LIKING", "LONGING", "PASSION", "THIRST", "WISH"
      ]
      
      const adverbsPool = [
        "AFFECTIONATELY", "ARDENTLY", "ANXIOUSLY", "BEAUTIFULLY", "BURNINGLY", "CURIOUSLY",
        "EAGERLY", "FONDLY", "IMPATIENTLY", "KEENLY", "LOVINGLY", "PASSIONATELY",
        "SEDUCTIVELY", "TENDERLY", "WISTFULLY"
      ]
      
      const verbsPool = [
        "ADORES", "ATTRACTS", "CLINGS TO", "HOLDS DEAR", "HOPES FOR", "HUNGERS FOR", "LIKES",
        "LONGS FOR", "LOVES", "LUSTS AFTER", "TREASURES"
      ]
